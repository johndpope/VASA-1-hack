...
class UpsampleModule(nn.Module):
    """Proper module for upsampling instead of lambda."""
...
class ResBlock(nn.Module):
    def __init__(
        ...
        if resize_layer_type in ['nearest', 'bilinear', 'blur']:
            # Replace lambda with proper upsampling module
            self.upsample = UpsampleModule(scale_factor=stride, mode=resize_layer_type)
