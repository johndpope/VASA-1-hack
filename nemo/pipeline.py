...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_image_path', type=str, default='data/4.png', help='Path to source image')
    parser.add_argument('--driven_video_path', type=str, default='junk/ovs-GiY_848_1.mp4', help='Path to driving video')
